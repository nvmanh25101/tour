    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="ms-4 me-4">
            <a class="d-block" href="{{ route('customers.home') }}">
                <svg class="nav-logo" viewBox="0 0 110 31">
                    <g>
            ...
            <ul class="list-unstyled mb-0 d-flex align-items-center justify-content-end nav-list">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Danh mục <div class="arrow-down"></div>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="topnav-pages">
                        @foreach($categories as $item)
                            <a href="{{ route('customers.home', ["category" => $item]) }}" class="dropdown-item">{{ $item->name }}</a>
                        @endforeach
                    </div>
                </li>
                <li>
                    <a class="nav-link" href="{{ route('favorite.index') }}" role="button">
