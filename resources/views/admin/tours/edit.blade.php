...
@section('content')
    <div class="col-12">
        ...
        @if(\Illuminate\Support\Facades\Auth::guard('admin')->user()->role !== \App\Enums\AdminType::CHAM_SOC_KHACH_HANG)
        {{ route('admin.tours.update', $tour) }}
        @endif
        " class="needs-validation"
            ...
            <div class="form-group mb-3">
                ...
                <textarea class="form-control" name="price_children"
                          placeholder="Giá khi có trẻ em">{{ $tour->price_children }}</textarea>
            </div>
            ...
            <button class="btn btn-primary mb-3" type="
            @if(\Illuminate\Support\Facades\Auth::guard('admin')->user()->role !== \App\Enums\AdminType::CHAM_SOC_KHACH_HANG)
                submit
              @else
                button
