			...
			if(bGTMaxDate || bLTMinDate)
			{
				...
				else
				{
					if(bCDGTMaxDate)
					{
						...
						console.log("Info : Date/Destination/DateTime you entered is later than Maximum value, so DateTimePicker is showing Maximum value in Input Field.");
					}
					if(bCDLTMinDate)
					{
						dTempDate = new Date(oDTP.oData.dMinValue);
						console.log("Info : Date/Destination/DateTime you entered is earlier than Minimum value, so DateTimePicker is showing Minimum value in Input Field.");
					}
					console.log("Please enter proper Date/Destination/DateTime values.");
				}
			}
